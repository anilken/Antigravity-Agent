...
description: Creates high-quality, predictable, and efficient skills for the Antigravity agent environment. Use when the user wants to create a new skill or modify an existing one.
---
